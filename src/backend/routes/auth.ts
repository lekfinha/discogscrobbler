...
/**
 * Creates the auth router with injected dependencies.
 * This factory pattern ensures services are created AFTER dotenv.config() runs,
 * so environment variables like ENCRYPTION_KEY are available.
 */
